...
const StepCard = ({ number, title, description }) => {
  return (
    <div className="relative p-6 bg-black rounded-xl manual-shadow hover:shadow-indigo-500/40 transition duration-300 ease-in-out transform hover:-translate-y-1">
